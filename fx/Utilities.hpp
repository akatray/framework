...
namespace fx::utl
{
	...
	class Shape
	{
		...
		// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		constexpr inline auto idx ( const u64 _X, const u64 _Y ) const -> u64 { return math::index_c(_X, _Y, this->Dimensions[1]); }

		// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		// Get index into 1D array from 3D position.
		// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		constexpr inline auto idx ( const u64 _X, const u64 _Y, const u64 _Z ) const -> u64 { return math::index_c(_X, _Y, _Z, this->Dimensions[1], this->Dimensions[2]); }
		...
		{
			return math::index_c(_X, _Y, _Z, _W, this->Dimensions[1], this->Dimensions[2], this->Dimensions[3]);
		}
